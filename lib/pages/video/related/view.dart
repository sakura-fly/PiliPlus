...
class _RelatedVideoPanelState extends State<RelatedVideoPanel> with GridMixin {
  ...
  void initState() {
    ...
    if (Get.isRegistered<RelatedController>(tag: widget.heroTag)) {
      _relatedController = Get.find<RelatedController>(tag: widget.heroTag);
    } else {
      _relatedController = Get.put(
        RelatedController(bvid: videoDetailController.bvid),
        tag: widget.heroTag,
        permanent: videoDetailController.isSplitScreen,
      );
    }
  }
